...
folder are mapped to the application's root namespace, 'KanbanExtJS'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "KanbanExtJS"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'KanbanExtJS' in the same way
as `"KanbanExtJS/sass/src"`.
